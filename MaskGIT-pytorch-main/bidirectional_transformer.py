...
class BidirectionalTransformer(nn.Module):
    def __init__(self, args):
        ...
        # Vocab layout: [0 .. K-1] codebook entries, K = MASK, K+1 = SOS,
        # then K+2 .. K+2+num_classes-1 = class-conditioning tokens.
        # num_classes=0 keeps the original unconditional vocab size.
        self.num_classes = int(getattr(args, "num_classes", 0))
        vocab_size = args.num_codebook_vectors + 2 + self.num_classes
        self.tok_emb = nn.Embedding(vocab_size, args.dim)
        ...
        self.bias = nn.Parameter(torch.zeros(self.num_image_tokens + 1, vocab_size))
