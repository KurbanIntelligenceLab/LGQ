#!/bin/bash
# LMB (LGQ) – squared L2 distance + kmeans init + scaled tau.
# Submitted by run_lmb_all_codebooks.sh or manually with CODEBOOK_SIZE.
#
#SBATCH --job-name=lmb_sq
...
TAG="lmb_sq_cb${CODEBOOK_SIZE}_256_s${SEED}"
echo "=== $TAG ==="
