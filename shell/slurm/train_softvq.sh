#!/bin/bash
# SoftVQ-VAE – soft assignment via temperature-scaled softmax (Chen et al., CVPR 2025).
# DDP on 4xH100 per hopper node. Submitted by submit_all.sh with CODEBOOK_SIZE set in the environment.
#
#SBATCH --job-name=softvq
...
TAG="softvq_cb${CODEBOOK_SIZE}_256_ddp${NGPUS}_gb${GLOBAL_BATCH}_s${SEED}"
echo "=== $TAG ==="
