#!/bin/bash
# abl1 recipe on 4 GPUs with disc_start=25000 (codebook-warmup ablation).
# Identical to train_lmb_abl1_ddp4.sh except --disc-start 25000 and run TAG.
#
#SBATCH --job-name=lmb_abl1_ddp4_disc25k
...
TAG="lmb_abl1_ddp4_disc25k_cb${CODEBOOK_SIZE}_s${SEED}"
echo "=== $TAG ==="
