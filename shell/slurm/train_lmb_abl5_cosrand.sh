#!/bin/bash
# Ablation 5: cosine similarity + random init + tau=1→0.1 (isolates cosine effect)
#
#SBATCH --job-name=lmb_abl5
...
TAG="lmb_abl5_cos_random_tau1_cb${CODEBOOK_SIZE}_s${SEED}"
echo "=== $TAG ==="
