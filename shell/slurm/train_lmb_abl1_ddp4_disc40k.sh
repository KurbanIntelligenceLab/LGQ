#!/bin/bash
# abl1 recipe on 4 GPUs with disc_start=40000 (codebook-warmup ablation).
# Identical to train_lmb_abl1_ddp4.sh except --disc-start 40000 and run TAG.
#
#SBATCH --job-name=lmb_abl1_ddp4_disc40k
...
TAG="lmb_abl1_ddp4_disc40k_cb${CODEBOOK_SIZE}_s${SEED}"
echo "=== $TAG ==="
